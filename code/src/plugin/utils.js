export default {
   ...
   */
  getCache(fields) {
    const cache = localStorage.getItem(fields.toUpperCase());
   ...
   */
  hasCache(fields) {
    return Object.prototype.hasOwnProperty.call(localStorage, fields.toUpperCase());
  },
  ...
  hasFields(obj, fields) {
    return Object.prototype.hasOwnProperty.call(obj, fields);
  },
